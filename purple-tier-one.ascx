...
<div id="Content">
    <header class="site-header container-fluid">
        ...
        <div class="row page-banners">
            <img src="/portals/0/images/what-we-do-top-bar.png" alt="what we do" title="what we do" />
    ...
    <div id="MainContent" class="container interior">
        ...
        <div class="row">
            <div id="LowerTwoColWideLeft" class="col-md-8" runat="server"></div>
            <div id="LowerColNarrowRight" class="col-md-4" runat="server"></div>
        </div>
        <div class="row">
